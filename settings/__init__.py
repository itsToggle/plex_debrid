...
settings_list = [
    ...
    ['Scraper Settings', [
        ...
        setting('Jackett Base URL', 'Please specify your Jackett base URL: ', scraper.services.jackett, 'base_url',
                hidden=True),
        setting('Jackett API Key', 'Please specify your Jackett API Key: ', scraper.services.jackett, 'api_key',
                hidden=True),
        setting('Jackett Indexers', ['Please specify a Jackett indexer (Leave blank to scrape all indexers): '],
                scraper.services.jackett, 'indexers', hidden=True, entry="indexer"),
        setting('Jackett Categories',
                ['Please specify a Jackett torrent category (Leave blank to scrape all categories): '],
                scraper.services.jackett, 'categories', hidden=True, entry="category"),
        setting('Jackett Filters', ['Please specify a Jackett indexer filter (Leave blank to not apply filter): '],
                scraper.services.jackett, 'categories', hidden=True, entry="filter"),
        setting('Prowlarr Base URL', 'Please specify your Prowlarr base URL: ', scraper.services.prowlarr, 'base_url',
                hidden=True),
        setting('Prowlarr API Key', 'Please specify your Prowlarr API Key: ', scraper.services.prowlarr, 'api_key',
                hidden=True),
    ]
        ],
    ['Debrid Services', [
